				...
				<div class="column is-8 is-offset-2">
					...
					while ($row = $result->fetch_assoc()) {
						...
						if($_SESSION['IsAdmin'] ?? null)
						{
							...
							if($_SESSION['IsAdmin'] == 1)
							{
							echo	'<form action = "../logic/EditAnnouncement.php" method = "post">
										...
										<div class="card-content">
											<div class="media">
												<div class="media-content has-text-centered">
													...
													<input class="button is-warning" type="submit" name="edit"    value="Edit Post"> </input> 
													<input class="button is-danger"  type="submit" name="delete"  value="Delete Post"> </input> 
												</div>
											</div>
